...
public class IQueryServiceStrategy extends GenerateStrategy {

    private final String CHARSET = "utf-8";
    private final Integer BUFFER_SIZE = 1024;

    public IQueryServiceStrategy(Class clazz, Map<String, String> parame) {
        this.clazz = clazz;
        this.parame = parame;
    }
    ...
    public void configParame() {
        ...
        // 使用模板文件
        String templateName = "IQueryService.ftl";
        // 业务模块名
        ...
        String fileName ="/" + module + "I" + className + "QueryService.java";
        String packageName = StringUtils.replaceToPath(parame.get("basePackage") + ".query.service");

        String filePath = "queryService/src/main/java/" + packageName + fileName;
